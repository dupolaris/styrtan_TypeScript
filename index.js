...
//Q36:
function make_shirt(tMessage, size) {
    console.log(tMessage + "\tSize: " + size + "\n");
}
make_shirt('My T-Shirt', 'XL');
const tSizeArray = ["S", "M", "L", "XL", "Custom"];
const tMessageArray = ["I love TypeScript ", "I love C++", "I love Apex", "I love Python", "I love Games"];
//Q37:
...
//Q40:
let trackCount = 0;
const make_Album = function (artist, title, trackNo = trackCount) {
    return {
        artist,
        title,
        trackNo,
...
console.log(album3);
//Q41:
const magicianArray = ["Roger Lapin", "David Copperfield", "Paul Daniels", "David Blaine", "Derren Brown"];
function showMagicians(mNames) {
    console.log(mNames);
}
...
showMagicians(greatMagicianArray);
//Q44:
function make_Sandwich(...itemsOfSandwich) {
